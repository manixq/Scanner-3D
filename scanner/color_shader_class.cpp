...
bool ColorShaderClass::Render(ID3D11DeviceContext* device_context, int index_count, D3DXMATRIX world_matrix, D3DXMATRIX view_matrix, D3DXMATRIX projection_matrix, ID3D11ShaderResourceView* normal, D3DXVECTOR3 light_direction)
{
 bool result;

 result = Set_shader_parameters(device_context, world_matrix, view_matrix, projection_matrix, normal, light_direction);
 if (!result)
  return false;
...
bool ColorShaderClass::Set_shader_parameters(ID3D11DeviceContext* device_context, D3DXMATRIX world, D3DXMATRIX view, D3DXMATRIX projection, ID3D11ShaderResourceView* normal, D3DXVECTOR3 light_direction)
{
    HRESULT result;
